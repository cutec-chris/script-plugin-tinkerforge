...
const
  ...
  BRICK_RED_DEVICE_DISPLAY_NAME = 'RED Brick';
...
type
  ...
  public
    ...
    ///  * Program = 5
    /// </summary>
    procedure GetListItem(const listId: word; const index: word; const sessionId: word; out errorCode: byte; out itemObjectId: word; out type2: byte); virtual;
    ...
    /// </summary>
    procedure GetFileInfo(const fileId: word; const sessionId: word; out errorCode: byte; out type2: byte; out nameStringId: word; out flags: longword; out permissions: word; out uid: longword; out gid: longword; out length2: uint64; out accessTimestamp: uint64; out modificationTimestamp: uint64; out statusChangeTimestamp: uint64); virtual;
    ...
    ///  * Socket = 7
    /// </summary>
    procedure GetNextDirectoryEntry(const directoryId: word; const sessionId: word; out errorCode: byte; out nameStringId: word; out type2: byte); virtual;
...
procedure TBrickRED.GetListItem(const listId: word; const index: word; const sessionId: word; out errorCode: byte; out itemObjectId: word; out type2: byte);
var request, response: TByteArray;
begin
  ...
  type2 := LEConvertUInt8From(11, response);
end;
...
procedure TBrickRED.GetFileInfo(const fileId: word; const sessionId: word; out errorCode: byte; out type2: byte; out nameStringId: word; out flags: longword; out permissions: word; out uid: longword; out gid: longword; out length2: uint64; out accessTimestamp: uint64; out modificationTimestamp: uint64; out statusChangeTimestamp: uint64);
var request, response: TByteArray;
begin
  ...
  response := SendRequest(request);
  errorCode := LEConvertUInt8From(8, response);
  type2 := LEConvertUInt8From(9, response);
...
procedure TBrickRED.GetNextDirectoryEntry(const directoryId: word; const sessionId: word; out errorCode: byte; out nameStringId: word; out type2: byte);
var request, response: TByteArray;
begin
