...
const
  ...
  BRICKLET_LED_STRIP_DEVICE_DISPLAY_NAME = 'LED Strip Bricklet';
...
type
  ...
  public
    ...
    /// <summary>
    ///  Returns the frame duration in ms as set by <see cref="BrickletLEDStrip.TBrickletLEDStrip.SetFrameDuration"/>.
    /// </summary>
